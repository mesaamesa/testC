...
void IOputmat(A,Nombre,Formato,Dim)
matriz A;
string Nombre;
char Formato;
unsigned int Dim;
...
void IOputvect(V,Nombre,Formato,Dim)
vector V;
string Nombre;
char Formato;
unsigned int Dim;
